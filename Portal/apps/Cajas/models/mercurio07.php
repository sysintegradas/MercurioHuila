...
class Mercurio07 extends ActiveRecord {
    ...
    public function getAgenciaDetalle(){
        $retorno="";
        switch($this->agencia){
            case '1': $retorno='NEIVA'; break;
            case '2': $retorno='GARZON'; break;
            case '3': $retorno='PITALITO'; break;
            case '4': $retorno='LA PLATA'; break;
        }
        return $retorno;
    }
