...
class Date extends Object {
	...
	public function getLocale(){
		$this->_locale = new Locale("es_CO");//nuevo cjse 
		if($this->_locale==null){//nuevo cjse 
			$locale = Locale::getApplication();//nuevo cjse 
			$this->_locale = $locale;//nuevo cjse 
			return $locale;//nuevo cjse 
		} else {//nuevo cjse 
			return $this->_locale;//nuevo cjse 
		}//nuevo cjse 
		/*//nuevo cjse 
		   if($this->_locale==null){//nuevo cjse 
		   $locale = Locale::getApplication();//nuevo cjse 
	...
	public function getLocaleDate($type='full'){
		...
		$config = CoreConfig::readAppConfig();//nuevo cjse 
		$format = strtolower($config->application->dbdate);//nuevo cjse 
		$dateFormat = new DateFormat($format);
		return $dateFormat->formatDate($this);
	}
