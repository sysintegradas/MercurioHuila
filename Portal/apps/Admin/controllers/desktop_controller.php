...
class DesktopController extends ApplicationController {
    ...
    public function indexAction(){
        $this->setParamToView("titulo","Mercurio");
    }
    ...
    public function showListNotasMsgAction(){
        ...
        $numero = $this->getPostParam("numero");
        $response="";
        $basica03 = $this->Basica03->findBySql("SELECT basica03.nota FROM basica03 WHERE basica03.numero = '$numero'");
        if($basica03!=false)
    ...
    public function showListContactAction(){
        ...
        foreach($basica01 as $mbasica01){
            ...
            foreach($basica02 as $mbasica02){
                $mgener02 = $this->Gener02->findBySql("SELECT gener02.nombre FROM gener02 WHERE gener02.usuario = '{$mbasica02->getUsuario()}'");
    ...
    public function showListChatAction(){
        ...
        foreach($basica04 as $mbasica04){
            $count_chat = $this->Basica05->findBySql("SELECT count(basica05.numero) as numero FROM basica04,basica05 WHERE basica04.numero=basica05.numero AND basica04.usuario='{$mbasica04->getUsuario()}' AND basica05.usuario=".parent::getActUser()." AND estado='D'")->getNumero();
            $det = "";
    ...
    public function showListChat2Action(){
        ...
        $response = "";
        $mbasica02 = $this->Basica02->findFirst("usuario='$usuario'");
        $count_chat = $this->Basica05->findBySql("SELECT count(basica05.numero) as numero FROM basica04,basica05 WHERE basica04.numero=basica05.numero AND basica04.usuario='$usuario' AND basica05.usuario=".parent::getActUser()." AND estado='D'")->getNumero();
        $det = "";
        if($count_chat>0)$det = " ($count_chat) ";
