...
--
-- Host: localhost    Database: mercurio_comfaguajira
-- ------------------------------------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=110023 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `mercurio22` (
  ...
  CONSTRAINT `fk_mercurio22_07` FOREIGN KEY (`codcaj`, `tipo`, `documento`) REFERENCES `mercurio07` (`codcaj`, `tipo`, `documento`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `mercurio30` (
  ...
  `motivo` char(100) DEFAULT NULL,
  `fecest` date DEFAULT NULL,
  `tipemp` enum('O','P','M') NOT NULL,
  `tipsoc` char(3) NOT NULL,
  `calemp` enum('E','F','P','D','N') NOT NULL,
  `codzon` char(9) NOT NULL,
  `autoriza` enum('S','N') NOT NULL,
  `zonsuc` char(9) NOT NULL,
...
--
-- Table structure for table `mercurio30f`
--

DROP TABLE IF EXISTS `mercurio30f`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mercurio30f` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `log` int(11) NOT NULL,
  `codcaj` char(6) NOT NULL,
  `nit` char(14) NOT NULL,
  ...
  `captra` enum('N','I') NOT NULL,
  `tipdis` char(2) NOT NULL,
  `nivedu` char(2) NOT NULL,
  `rural` enum('S','N') NOT NULL,
  `horas` int(11) NOT NULL,
  `tipcon` enum('F','I') NOT NULL,
  `vivienda` enum('N','F','P','A','H') NOT NULL,
  `autoriza` enum('S','N') NOT NULL,
  `estado` enum('P','A','X') NOT NULL,
  `motivo` char(100) DEFAULT NULL,
  `fecest` date DEFAULT NULL,
  ...
  `usuario` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_mercurio30f_mercurio211_idx` (`log`),
  KEY `fk_mercurio30f_mercurio021_idx` (`codcaj`),
  CONSTRAINT `fk_mercurio30f_mercurio021` FOREIGN KEY (`codcaj`) REFERENCES `mercurio02` (`codcaj`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_mercurio30f_mercurio211` FOREIGN KEY (`log`) REFERENCES `mercurio21` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `mercurio32` (
  ...
  `telefono` char(13) NOT NULL,
  `email` char(45) NOT NULL,
  `captra` enum('I','N') NOT NULL,
  `nivedu` char(2) NOT NULL,
  `fecing` date NOT NULL,
  `codocu` char(5) NOT NULL,
  `salario` int(11) NOT NULL,
  `estado` enum('P','A','X') NOT NULL,
  `motivo` char(100) DEFAULT NULL,
  `fecest` date DEFAULT NULL,
...
-- Dump completed on 2017-02-02 10:31:52
